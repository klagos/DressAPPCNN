...
classification_metrics = metrics.classification_report(test_labels, preds, target_names=etiquetas )
...
plot_confusion_matrix(confusion_matrix, etiquetas)
...
def test_single_image(path):
    ...
    for idx, animal, x in zip(range(0,16), etiquetas , preds[0]):
